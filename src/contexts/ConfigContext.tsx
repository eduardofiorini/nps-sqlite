            ...
            <div className="flex items-center">
              ...
              <Link to="/overview" className="flex items-center">
                ...
                <div className="flex flex-col">
                  <span className="text-xl font-bold theme-text dark:text-white">Meu NPS</span>
            ...
            <nav className="hidden md:flex items-center space-x-4">
              ...
              <div className="relative">
                <select
                  ...
                  className="appearance-none bg-transparent border border-gray-300 dark:border-gray-600 rounded-lg px-3 py-2 pr-8 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 theme-ring transition-colors"
                >
              ...
              {user && (
                <div className="relative user-dropdown">
                  ...
                  >
                    <div 
                      className="w-8 h-8 rounded-full text-white flex items-center justify-center mr-3 text-sm font-medium theme-bg"
                    >
