          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              ...
              <div className="flex space-x-4">
                ...
                >
                  <svg className="w-5 h-5 text-gray-400 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.62 5.367 11.987 11.988 11.987s11.987-5.367 11.987-11.987C24.004 5.367 18.637.001 12.017.001zM8.449 16.988c-1.297 0-2.448-.49-3.323-1.297C4.198 14.895 3.708 13.744 3.708 12.447s.49-2.448 1.418-3.323c.875-.807 2.026-1.297 3.323-1.297s2.448.49 3.323 1.297c.928.875 1.418 2.026 1.418 3.323s-.49 2.448-1.418 3.244c-.875.807-2.026 1.297-3.323 1.297zm7.83-9.608h-1.509c-.123 0-.219-.096-.219-.219V5.653c0-.123.096-.219.219-.219h1.509c.123 0 .219.096.219.219v1.508c0 .123-.096.219-.219.219zm-3.532 9.608c-2.509 0-4.541-2.032-4.541-4.541s2.032-4.541 4.541-4.541 4.541 2.032 4.541 4.541-2.032 4.541-4.541 4.541z"/>
                  </svg>
                </a>
                <a 
